...
default_ellipse_xscale = 1
default_ellipse_yscale = 1
default_color = 0x92AECF
default_alpha = 0.35
default_center_x = 500*(1/default_ellipse_xscale)
default_center_y = 501*(1/default_ellipse_yscale)

iron_arc_cpu_r = 127
iron_arc_cpu_thickness = 6
...
settings_table = {
	{
		...
		radius = iron_arc_cpu_r,
		thickness = iron_arc_cpu_thickness,
		start_angle = 5,
		end_angle = 40,
		from_middle = true,
		backwards = false,
...
clock_r = 122
clock_gauge_start_perc = 0.97
clock_gauge_end_perc = 0.75
clock_gauges_num = 8
...
function draw_clock_hands(cr,xc,yc)
	...
	xh_o = xc+clock_gauge_end_perc*clock_r*math.sin(hours_arc)
	yh_o = yc-clock_gauge_end_perc*clock_r*math.cos(hours_arc)
	xh_i = xc+clock_gauge_start_perc*clock_r*math.sin(hours_arc)
	yh_i = yc-clock_gauge_start_perc*clock_r*math.cos(hours_arc)
	...
	xm_o = xc+clock_gauge_end_perc*clock_r*math.sin(mins_arc)
	ym_o = yc-clock_gauge_end_perc*clock_r*math.cos(mins_arc)
	xm_i = xc+clock_gauge_start_perc*clock_r*math.sin(mins_arc)
	ym_i = yc-clock_gauge_start_perc*clock_r*math.cos(mins_arc)
...
function draw_clock_gauges(cr, xc, yc)
	...
	local innerMin = 1.0 --0.77
	local innerMax = 1.0 --0.77
	local outerMin = 0.75 --1.0
	local outerMax = 0.75 --1.0
